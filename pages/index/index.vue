<template>
	<view id="moments">
		...
		<swiper :indicator-dots="true" :autoplay="true" :interval="3000" :duration="1000" style="height: 400upx;">
			<block v-for="image in imageList" >
				<swiper-item>
		...
		<view v-if="page.list.length == 0" style="width: 100%; height: 750upx; display: flex; flex-direction: column; align-items: center; justify-content: center;">
			<text>空空如也</text>
		</view>
		<view v-else class="moments__post" v-for="(post,index) in page.list" :key="index" id="id">
