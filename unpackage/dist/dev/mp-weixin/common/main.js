...
/* 0 */
/*!************************************************!*\
  !*** F:/HBuilderXProjects/campus-blog/main.js ***!
  \************************************************/
...
_vue.default.prototype.serverUrl = "http://127.0.0.1:8081/renren-api/";

_App.default.mpType = 'app';


_vue.default.prototype.getSessionUrl = function (url) {
...
_vue.default.prototype.getGlobalUser = function () {
...
_vue.default.prototype.setGlobalUser = function (user) {
  uni.setStorageSync("globalUser", user);
};

_vue.default.prototype.removeGlobalUser = function () {
  uni.removeStorageSync("globalUser");
};

_vue.default.prototype.reLogin = function () {
  var _this = this;
...
_vue.default.prototype.isNotEmpty = function (value) {
  return !this.isEmpty(value);
};

_vue.default.prototype.isEmpty = function (value) {
...
_vue.default.prototype.notLoginToLogin = function () {
  var b = this.isLogin();
  if (!b) {
    this.toLogin();
  }
...
_vue.default.prototype.toLogin = function (suffix) {
  console.log(suffix);
...
_vue.default.prototype.emailCheck = function (email) {
...
_vue.default.prototype.accountCheck = function (account) {
  var reg = /^20[0-9]{8}$/;
  return this.checkStr(reg, account, "学号");
};

_vue.default.prototype.passwordCheck = function (password) {
  var reg = /^[0-9a-zA-Z]{6,12}$/;
  var msg = this.checkStr(reg, password, "密码");
  return msg == "密码格式不正确" ? "密码格式为数字字母6到12位字符" : msg;
};

_vue.default.prototype.verCodeCheck = function (verCode) {
  var reg = /^[0-9]{6}$/;
  return this.checkStr(reg, verCode, "验证码");
};

_vue.default.prototype.nameCheck = function (name) {
  var reg = /^[\u4E00-\u9FA5]{2,4}$/;
  return this.checkStr(reg, name, "姓名");
};

_vue.default.prototype.checkStr = function (reg, str, msg) {
  console.log("str:" + str);
  if (this.isEmpty(str)) {
    return msg + "不能为空";
...
_vue.default.prototype.getUrl = function (url, data) {
  console.log(url);
  console.log(data);
...
/* 9 */
/*!************************************************!*\
  !*** F:/HBuilderXProjects/campus-blog/App.vue ***!
  \************************************************/
/*! no static exports found */
...
/* hot reload */
if (false) { var api; }
component.options.__file = "F:/HBuilderXProjects/campus-blog/App.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),
/* 10 */
/*!*************************************************************************!*\
  !*** F:/HBuilderXProjects/campus-blog/App.vue?vue&type=script&lang=js& ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 12 */
/*!*********************************************************************************!*\
  !*** F:/HBuilderXProjects/campus-blog/App.vue?vue&type=style&index=0&lang=css& ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
